...
export function Template(props: TemplateProps<KcContext, I18n>) {
    ...
    return (
        <div className="bg-background min-h-screen flex flex-col items-center justify-center prose dark:prose-invert max-w-none">
            ...
            <div>
                <footer className="w-full max-w-7xl mx-auto px-6 py-8">
                    <div className="flex flex-col border-t border-gray-200 dark:border-gray-700 pt-8">
                        {/* Logo section */}
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 items-center justify-items-center mb-6">
                            <img src={`${PUBLIC_URL}/img/BUMN.png`} className="w-auto h-8 object-contain" alt="BUMN Logo" />
                            <img src={`${PUBLIC_URL}/img/PKG.png`} className="w-auto h-12 object-contain" alt="PETROKIMIA GRESIK Logo" />
                            <img src={`${PUBLIC_URL}/img/PI.png`} className="w-auto h-14 object-contain" alt="PUPUK INDONESIA Logo" />
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center">
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-2 md:mb-0">
                                &copy; 2025 OneKey. All rights reserved.
                            </div>
                            <div className="text-sm text-gray-400 dark:text-gray-500 flex items-center">
                                <img 
                                    src={`${PUBLIC_URL}/img/logo_only.png`} 
                                    className="w-4 h-4 mr-1 object-contain" 
                                    alt="OneKey Logo" 
                                />
                                <span>Powered by OneKey Integration Platform</span>
                            </div>
                        </div>
                    </div>
                </footer>
